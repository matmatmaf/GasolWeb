...
<body>
    <header class="header pagina-principal">
        ...
        <div class="portada portada-margin">
            <?php 
                ...
                if ( $object->taxonomy != 'page' || $object->post_type === 'post' ) {
                    $pageID = get_option('page_on_front'); 
                }
                else {
                    $pageID = $object->ID;
                }
                $thumbnailToShow = get_the_post_thumbnail( $pageID, 'full', array('class' => 'imagen-portada'));
            ?>
            <div class="imgFondo">
                <?php
                if ( $thumbnailToShow != '') {
                    echo $thumbnailToShow;
                }
                ?>
            </div>
            <div class="textoPortada">
                <div class="titulo"><?php the_field('leyenda_portada');?></div>
            </div>
        </div>
    </header>
    ...
    <main>
        ...
        <?php if ($object->taxonomy): ?>
            <section class="tituloTaxonomia">
                <H1>
                    <?php
